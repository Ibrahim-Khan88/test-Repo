...
@Component({
  selector: 'app-investigation-update',
  templateUrl: './investigation-update.component.html',
  styleUrls: ['./investigation-update.component.css']
})
export class InvestigationUpdateComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.investigation = this.localStoregeService.retrieve("investigation");
    if(this.investigation == null){
      ...
      this.investigationForm.get('name').setValue(this.investigation.name);
      this.investigationForm.get('code').setValue(this.investigation.code);
      this.investigationForm.get('discountPer').setValue(this.investigation.discountPer);
      this.investigationForm.get('discountAmount').setValue(this.investigation.discountAmount);
      this.investigationForm.get('note').setValue(this.investigation.note);
      this.investigationForm.get('selectionCode').setValue(this.investigation.selectionCode);
      this.investigationForm.get('sortingId').setValue(this.investigation.sortingId);
      this.investigationForm.get('unit').setValue(this.investigation.unit);
      this.investigationForm.get('vatApplyAmount').setValue(this.investigation.vatApplyAmount);
      this.investigationForm.get('rate').setValue(this.investigation.rate);
      this.investigationForm.get('refValue').setValue(this.investigation.refValue);
      this.investigationForm.get('resultType').setValue(this.investigation.resultType);
      this.investigationForm.get('description').setValue(this.investigation.description);
      this.formatValue = this.investigation.format;
